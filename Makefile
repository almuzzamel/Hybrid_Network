#
# OMNeT++/OMNEST Makefile for $(LIB_PREFIX)abcd
#
# This file was generated with the command:
#  opp_makemake --make-so -f --deep -O out -KINET4_5_PROJ=../inet4.5 -KSIMU5G_PROJ=../simu5g -DINET_IMPORT -I. -I$$\(INET4_5_PROJ\)/src -I$$\(SIMU5G_PROJ\)/src -L$$\(INET4_5_PROJ\)/src -L$$\(SIMU5G_PROJ\)/src -Lout/$$\(CONFIGNAME\)/src -lINET$$\(D\) -lsimu5g$$\(D\) -d src
#

# Name of target to be created (-o option)
TARGET_DIR = .
TARGET_NAME = $(LIB_PREFIX)abcd$(D)
...
LIBS = $(LDFLAG_LIBPATH)$(INET4_5_PROJ)/src $(LDFLAG_LIBPATH)$(SIMU5G_PROJ)/src $(LDFLAG_LIBPATH)out/$(CONFIGNAME)/src  -lINET$(D) -lsimu5g$(D)
...
LIBS += -Wl,-rpath,$(abspath $(INET4_5_PROJ)/src) -Wl,-rpath,$(abspath $(SIMU5G_PROJ)/src) -Wl,-rpath,$(abspath out/$(CONFIGNAME)/src)
endif

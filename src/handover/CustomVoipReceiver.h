...
//
#ifndef __CUSTOM_VOIP_RECEIVER_H
#define __CUSTOM_VOIP_RECEIVER_H
 ...
 */
class ABCD_API CustomVoipReceiver : public cSimpleModule, public LifecycleUnsupported, public UdpSocket::ICallback
{
  public:
    ...
    class TalkspurtInfo {
      ...
      public:
        TalkspurtInfo() {}
        void startTalkspurt(const CustomVoipPacket *pk);
        void finishTalkspurt() { status = FINISHED; packets.clear(); }
        bool checkPacket(const CustomVoipPacket *pk);
        void addPacket(const CustomVoipPacket *pk);

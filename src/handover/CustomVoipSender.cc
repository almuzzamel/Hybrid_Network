...
Define_Module(inet::CustomVoipSender);

CustomVoipSender::CustomVoipSender()
{
}
...
void CustomVoipSender::initialize(int stage)
{
...
void CustomVoipSender::handleMessage(cMessage *msg)
{
...
void CustomVoipSender::talkspurt(simtime_t dur)
{
...
void CustomVoipSender::selectTalkOrSilenceInterval()
{
